...
#sonar
sonar_in_serial = '/dev/tty_sonar_in'
sonar_out_serial = '/dev/tty_sonar_out' # /dev/ttyS0'
data_path_out = "/data/s500/"

serialPort = serial.Serial(
port=sonar_in_serial, baudrate=115200, bytesize=8, timeout=2, stopbits=serial.STOPBITS_ONE
)
serialString = ""  # Used to hold data coming over UART
# 2nd port for writing nmea data ot
ser = serial.Serial(sonar_out_serial, baudrate=9600, bytesize=8, timeout=0.25,stopbits=serial.STOPBITS_ONE)
...
file_name = data_path_out + d4 + "/" + currTS2 + ".dat"
